...
{
    public class CultivoDAO : ICultivoDAO // Classe DAO (Data Access Object) para manipulação de dados de cultivos no banco de dados
    {
        private readonly string connectionString;
        public CultivoDAO(string connectionString)
        {
        ...
        public List<Cultivo> ListarCultivosComFiltros(string search)
        {
            ...
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                ...
                string query = @"SELECT id_cultivo, nome_cultivo, variedade_cultivo, tempoprodtrad_cultivo, tempoprodctrl_cultivo, categoria_cultivo, ativo_cultivo
                                 FROM cultivo
                                 WHERE nome_cultivo LIKE @search OR variedade_cultivo LIKE @search OR categoria_cultivo LIKE @search";
